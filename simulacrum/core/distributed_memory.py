...
class DistributedMemoryStore(nn.Module):
    ...
    def encode(
        ...
        fragments['hippocampus'] = MemoryFragment(
            ...
            region='hippocampus',
            encoding=hc_enc.detach().cpu().numpy()[0],
        ...
        fragments['amygdala'] = MemoryFragment(
            ...
            region='amygdala',
            encoding=amy_enc.detach().cpu().numpy()[0],
            timestamp=len(self._timeline),
        )
        ...
        fragments['prefrontal'] = MemoryFragment(
            ...
            region='prefrontal',
            encoding=pfc_enc.detach().cpu().numpy()[0],
            timestamp=len(self._timeline),
        )
        ...
        fragments['thalamus'] = MemoryFragment(
            ...
            region='thalamus',
            encoding=thal_enc.detach().cpu().numpy()[0],
            timestamp=len(self._timeline),
        )
    ...
    def retrieve(
        ...
        for region_name, encoder in self.region_encoders.items():
            ...
            query_np = query_enc.detach().cpu().numpy()[0]
