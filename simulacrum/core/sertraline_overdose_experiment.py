...
class OverdoseReport:
    ...
    time_of_death_h: float | None = None
    cause_of_death: str = ""
...
def run_sertraline_overdose(
    ...
    from core.drug_pipeline.pkpd import PKPDParams, simulate_pkpd
    from core.drug_pipeline.risk_to_ic50 import OrganIC50Profile, admet_to_ic50, smiles_to_pkpd_params
