...
class ModalityProjector(nn.Module):
    ...
    def __init__(self, input_dims: dict[str, int], embed_dim: int = 256):
        ...
        # PERF-03: Freeze orthogonal projections — they define the
        # coordinate mapping and should not be updated by gradient descent.
...
class CrossModalPredictor(nn.Module):
    ...
    def __init__(self, embed_dim: int = 256, output_dims: dict[str, int] | None = None):
        super().__init__()
...
class TemporalBindingBuffer:
    ...
    def get_recent_context(self) -> dict[str, torch.Tensor | None]:
        """获取每个模态最近的表征"""
        context = {}
