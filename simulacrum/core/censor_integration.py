...
class CensorPerceptionModule:
    ...
    def __init__(
        ...
        # 缓存最近一次结果
        self._last_result: MicroExpressionResult | None = None
    ...
    def _on_micro_expression_process(self, event) -> dict[str, Any] | None:
    ...
    def _on_sensory_process(self, event) -> dict[str, Any] | None:
    ...
    def get_last_result(self) -> MicroExpressionResult | None:
        """获取最近一次推理结果"""
        return self._last_result
