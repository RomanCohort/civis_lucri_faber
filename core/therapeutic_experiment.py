...
class ExperimentConfig:
    ...
    llm_evaluation_timepoints: list[int] | None = None
...
class TreatmentTimepoint:
    ...
    psychometrics: dict[str, float] | None = None
    # 疗法
    ...
    # 症状追踪 (SymptomTracker)
    symptom_snapshot: Any | None = None
    # 成瘾动力学
...
class TherapeuticExperiment:
    ...
    def __init__(
        ...
        # DDI状态
        self._ddi_result: Any | None = None
        ...
        # 成瘾动力学引擎
        self._addiction_engine: Any | None = None

        # 症状追踪器
        self._symptom_tracker: Any | None = None

        # 病原体炎症引擎
        self._pathogen_engine: Any | None = None
