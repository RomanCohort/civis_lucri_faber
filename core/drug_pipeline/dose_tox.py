        ...
        for organ in ORGAN_SYSTEMS:
            ...
            for match in tox_report.matches:
                if match.severity in _TOXOPHORE_ORGAN_FACTOR:
                    ...
                    if match.category in ("hepatotoxic",) and organ == "hepatic" or match.category in ("mutagenic", "carcinogenic") and organ == "hematologic":
...
# Global instance
_model: DoseToxicityModel | None = None
