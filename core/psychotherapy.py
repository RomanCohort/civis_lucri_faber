...
class PsychotherapySystem:
    ...
    def step(self, synergy_bonuses: Optional[Dict[str, float]] = None) -> Dict[str, Any]:
        """每步推进所有活跃治疗
    ...
    def get_treatment_state(self, modality: str) -> Optional[Dict]:
        """获取特定治疗的当前状态"""
        mod_enum = self._resolve_modality(modality)
        if mod_enum is None:
            return None
    ...
    @staticmethod
    def _resolve_modality(name: str) -> Optional[TherapyModality]:
        """流派名→枚举"""
        aliases = {
