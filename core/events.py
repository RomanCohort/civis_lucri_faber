...
HIBERNATE_EXIT = "hibernate_exit"     # 退出休眠
SYSTEM_DEAD = "system_dead"           # 数字死亡
COMPRESSION_NEEDED = "compression_needed"  # 需要压缩
METABOLIC_BUDGET_LOW = "metabolic_budget_low"  # 代谢预算不足
...
NEUROTRANSMITTER_UPDATE = "neurotransmitter_update"  # 神经递质系统更新

# ===== 学习/奖励事件 =====
REWARD_SIGNAL = "reward_signal"          # 奖励信号
ACTION_SELECTED = "action_selected"      # 行动选择完成
CURIOSITY_TRIGGER = "curiosity_trigger"  # 好奇心触发
SLEEP_CYCLE = "sleep_cycle"              # 睡眠周期
...
ALL_EVENTS = [
    STEP_START, STEP_END,
    THERMO_STATE, HIBERNATE_ENTER, HIBERNATE_EXIT, SYSTEM_DEAD, COMPRESSION_NEEDED, METABOLIC_BUDGET_LOW,
    ...
    MOTOR_CONTROL, VOCALIZATION_CONTROL, VOCALIZATION_OUTPUT, NEUROTRANSMITTER_UPDATE,
    MEMORY_ENCODE, PRUNING_UPDATE,
    OUTPUT_FILTER, LEARNING_TRIGGER,
    REWARD_SIGNAL, ACTION_SELECTED, CURIOSITY_TRIGGER, SLEEP_CYCLE,
...
# Re-export EventBus and Event from event_bus for convenience
