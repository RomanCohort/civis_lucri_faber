...
try:
    from simulacrum.core.events import EventBus, SENSORY_PROCESS
except ImportError:
    from events import EventBus, SENSORY_PROCESS
...
class SensoryNeuroCoupling:
    ...
    def __init__(self, event_bus: EventBus):
        ...
        # 上一帧的感觉输入 (用于新颖性检测)
        self._previous_sensory_input: Optional[Dict[str, float]] = None
    ...
    def _extract_language_vad(self, internal_state: Dict) -> Dict:
        ...
        # 尝试从语言皮层获取
        language_valence = internal_state.get('language_valence', None)
        language_arousal = internal_state.get('language_arousal', None)
